<template>
  <div class="p-6">
    <h1 class="mb-4 text-lg font-medium" style="color: var(--color-text)">Personality</h1>
    <div class="max-w-lg space-y-4">
      <div>
        <label class="mb-1 block text-xs font-medium" style="color: var(--color-text-dim)">Default Preset</label>
        <select
        ...
        <p class="mt-1 text-xs" style="color: var(--color-text-dim)">{{ presetDescription }}</p>
      </div>
      <div>
        <label class="mb-1 block text-xs font-medium" style="color: var(--color-text-dim)">Custom System Prompt (overrides preset)</label>
        <textarea
...
const presets = [
  ...
  { id: "collaborator", name: "Collaborator", desc: "Conversational and direct." },
  { id: "analyst", name: "Analyst", desc: "Detail-oriented, cites reasoning." },
  { id: "coach", name: "Coach", desc: "Encouraging, step-by-step explanations." },
  { id: "editor", name: "Editor", desc: "Document-aware, actionable feedback." },
