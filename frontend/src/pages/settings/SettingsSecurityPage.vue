    ...
    <div class="max-w-lg space-y-4">
      ...
      >
        ...
        <p class="mt-1 text-xs" style="color: var(--color-text-dim)">
          MFA setup will be available in a future update.
        </p>
        <button
          class="mt-2 rounded px-3 py-1.5 text-sm font-medium opacity-50"
      ...
      >
        ...
        <p class="mt-1 text-xs" style="color: var(--color-text-dim)">
          Manage connected OAuth providers (Google, Microsoft, GitHub).
        </p>
        <div class="mt-2 space-y-1">
          <div
            v-for="provider in ['Google', 'Microsoft', 'GitHub']"
            :key="provider"
