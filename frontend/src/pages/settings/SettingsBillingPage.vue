    ...
    <div class="max-w-lg space-y-4">
      ...
      >
        ...
        <p class="mt-1 text-xs" style="color: var(--color-text-dim)">
          View your token usage across all sessions. Detailed billing coming in
          a future update.
        </p>
        <div class="mt-3">
          ...
          <div v-else-if="usage.length > 0" class="space-y-2">
            ...
            >
              ...
              <span class="text-xs" style="color: var(--color-text-dim)">
                {{ entry.totalInput }} in / {{ entry.totalOutput }} out — ${{
                  entry.totalCost
                }}
              </span>
            </div>
          </div>
          <p v-else class="text-xs" style="color: var(--color-text-dim)">
