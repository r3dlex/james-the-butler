<template>
  <div class="p-6">
    ...
    >
      ...
      <div>
        <label class="mb-1 block text-xs" style="color: var(--color-text-dim)"
          >Matcher (pipe-separated tool names, optional)</label
        >
        <input
          v-model="newMatcher"
          type="text"
    ...
    <EmptyState
      ...
      message="No hooks configured. Hooks let you run commands or webhooks in response to agent events."
    />
