    ...
    <div class="max-w-lg space-y-4">
      ...
      >
        ...
        <p class="mt-1 text-xs" style="color: var(--color-text-dim)">
          Configure the desktop control daemon for screen capture and input
          automation. Requires Accessibility and Screen Recording permissions on
          macOS.
        </p>
